...
export const stats = [
  ...
  {value: '5', label: 'In-house disciplines', labelAr: 'تخصصات داخلية'},
  {value: '5–15%', label: 'Cost savings via value engineering', labelAr: 'وفورات تكلفة عبر هندسة القيمة'},
  {value: '450', label: 'Professionals across Mir Group', labelAr: 'متخصصاً ضمن مجموعة مير'},
];
...
export const mission = {
  en: 'To respond to clients’ growing needs with professional service focused on current innovations and developments.',
  ar: 'تلبية الاحتياجات المتنامية للعملاء بخدمة مهنية تركز على أحدث الابتكارات والتطورات.',
};

export const strengths = [
  {
    title: 'Quality output',
    titleAr: 'جودة المخرجات',
    copy: 'Drawings, specifications and bills of quantities are checked across disciplines before issue.',
    copyAr: 'تُراجع الرسومات والمواصفات وجداول الكميات بين التخصصات قبل إصدارها.',
  },
  {
    title: 'Timely reporting',
    titleAr: 'تقارير في مواعيدها',
    copy: 'Scheduled progress, cost and quality reporting supports the full project lifecycle.',
    copyAr: 'تدعم تقارير التقدم والتكلفة والجودة المجدولة دورة حياة المشروع كاملة.',
  },
  {
    title: 'A working relationship',
    titleAr: 'علاقة عمل مستمرة',
    copy: 'Project records are retained and remain available to clients after handover.',
    copyAr: 'تُحفظ سجلات المشروع وتظل متاحة للعملاء بعد التسليم.',
  },
];
...
export const standards = [
  {name: 'UAE Civil Defence', use: 'Fire and life safety', nameAr: 'الدفاع المدني الإماراتي', useAr: 'الحريق وسلامة الأرواح'},
  {name: 'NFPA', use: 'Fire protection systems', nameAr: 'NFPA', useAr: 'أنظمة الحماية من الحريق'},
  {name: 'CE standards', use: 'Equipment and materials', nameAr: 'معايير CE', useAr: 'المعدات والمواد'},
  {name: 'British Standards', use: 'Structural and building works', nameAr: 'المعايير البريطانية', useAr: 'الأعمال الإنشائية وأعمال المباني'},
  {name: 'Estidama Pearl Rating System', use: 'Sustainability rating', nameAr: 'نظام استدامة للتقييم باللؤلؤ', useAr: 'تقييم الاستدامة'},
  {name: 'Municipality development codes', use: 'Permitting and area plans', nameAr: 'أكواد التطوير البلدية', useAr: 'التصاريح ومخططات المناطق'},
];
