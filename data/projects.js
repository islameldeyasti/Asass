...
const records = [
  ...
  ['showroom-musaffah-m42', 'Showroom — M42', 'صالة عرض — M42', 'industrial', 'Musaffah Industrial, M42', 'مصفح الصناعية، M42', 'Showroom within the Musaffah industrial area.', 'صالة عرض ضمن منطقة مصفح الصناعية.', true, [], 33],
  ['industrial-facility-musaffah-m42', 'Industrial Facility — M42', 'منشأة صناعية — M42', 'industrial', 'Musaffah Industrial, M42', 'مصفح الصناعية، M42', 'Industrial facility within the Musaffah industrial area.', 'منشأة صناعية ضمن منطقة مصفح الصناعية.', true, [], 33],
  ['industrial-facility-musaffah-m15', 'Industrial Facility — M15', 'منشأة صناعية — M15', 'industrial', 'Musaffah Industrial, M15', 'مصفح الصناعية، M15', 'Industrial facility within the Musaffah industrial area.', 'منشأة صناعية ضمن منطقة مصفح الصناعية.', true, [], 33],
  ...
  ['american-international-school', 'American International School', 'المدرسة الأمريكية الدولية', 'education', null, null, 'School project included in the ASAS selected portfolio.', 'مشروع مدرسة ضمن أعمال أساس للاستشارات الهندسية وإدارة المشاريع المختارة.', true, [], 35],
  ...
  ['private-villa-mbz-z14', 'Private Villa — Z14', 'فيلا خاصة — Z14', 'private-villas', 'Mohammed Bin Zayed City, Z14', 'مدينة محمد بن زايد، Z14', 'Ground, first-floor and roof private villa.', 'فيلا خاصة من طابق أرضي وأول وسطح.', true, [], 37],
