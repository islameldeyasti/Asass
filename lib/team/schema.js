...
export function emptyTeamMember(overrides = {}) {
  ...
  return {
    ...
    updated_at: now,
    ...overrides,
    digital_card: normalizeDigitalCard(overrides.digital_card),
  };
}
...
export function normalizeTeamMember(input = {}, {generateId = false} = {}) {
  ...
  return {
    ...
    secondary_image_focal: asString(input.secondary_image_focal) || '50% 40%',
    ...
    updated_at: now,
    digital_card: normalizeDigitalCard(input.digital_card),
  };
}
